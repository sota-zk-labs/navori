module verifier_addr::stark_verifier_7 {
    ...
    */
    ...
    fun init_verifier_params(
        ...
        assert!(proof_params_length > PROOF_PARAMS_FRI_STEPS_OFFSET, INVALID_PROOF_PARAMS);
        assert!(
    ...
    fun air_specific_init(public_input: &vector<u256>): (vector<u256>, u256) {
        ...
        assert!(public_input_length >= OFFSET_PUBLIC_MEMORY, PUBLIC_INPUT_IS_TOO_SHORT);
        ...
        assert!(expected_public_input_length == (public_input_length as u256), PUBLIC_INPUT_LENGTH_MISMATCH);
    ...
    */
    fun verify_memory_page_facts(
        ...
        for (page in *ptr..end_ptr) {
            ...
            assert!(is_valid(signer_addr, fact_hash), MEMORY_PAGE_FACT_NOT_REGISTERED);
        };
        *ptr = end_ptr;
