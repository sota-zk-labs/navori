...
{
let val = fpow(/*trace_generator*/ trace_generator, ((/*trace_length*/ trace_length + (PRIME - 16)) % PRIME));
*borrow_mut(&mut ctx, 327) = val;
};
// expmods[42] = trace_generator^(trace_length - 2)
{
let val = fpow(/*trace_generator*/ trace_generator, ((/*trace_length*/ trace_length + (PRIME - 2)) % PRIME));
*borrow_mut(&mut ctx, 328) = val;
};
// expmods[43] = trace_generator^(trace_length - 4)
{
let val = fpow(/*trace_generator*/ trace_generator, ((/*trace_length*/ trace_length + (PRIME - 4)) % PRIME));
*borrow_mut(&mut ctx, 329) = val;
};
// expmods[44] = trace_generator^(trace_length - 1)
{
let val = fpow(/*trace_generator*/ trace_generator, ((/*trace_length*/ trace_length + (PRIME - 1)) % PRIME));
*borrow_mut(&mut ctx, 330) = val;
};
// expmods[45] = trace_generator^(trace_length - 2048)
{
let val = fpow(/*trace_generator*/ trace_generator, ((/*trace_length*/ trace_length + (PRIME - 2048)) % PRIME));
*borrow_mut(&mut ctx, 331) = val;
};
// expmods[46] = trace_generator^(trace_length - 128)
{
let val = fpow(/*trace_generator*/ trace_generator, ((/*trace_length*/ trace_length + (PRIME - 128)) % PRIME));
*borrow_mut(&mut ctx, 332) = val;
};
// expmods[47] = trace_generator^(trace_length - 64)
{
let val = fpow(/*trace_generator*/ trace_generator, ((/*trace_length*/ trace_length + (PRIME - 64)) % PRIME));
...
{
let val = ((/*(point^(trace_length/16))*/ *borrow(&ctx, 291) + (PRIME - /*(trace_generator^((15*trace_length)/16))*/ *borrow(&ctx, 322))) % PRIME);
...
{
let val = ((/*(point^(trace_length/64))*/ *borrow(&ctx, 289) + (PRIME - /*(trace_generator^((3*trace_length)/4))*/ *borrow(&ctx, 316))) % PRIME);
...
{
let val = ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((3*trace_length)/4))*/ *borrow(&ctx, 316))) % PRIME);
...
{
let val = fmul(fmul(fmul(fmul(fmul(fmul(fmul(fmul(fmul(fmul(fmul(fmul(fmul(fmul(fmul(((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^(trace_length/64))*/ *borrow(&ctx, 295))) % PRIME), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^(trace_length/32))*/ *borrow(&ctx, 296))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((3*trace_length)/64))*/ *borrow(&ctx, 297))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^(trace_length/16))*/ *borrow(&ctx, 298))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((5*trace_length)/64))*/ *borrow(&ctx, 299))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((3*trace_length)/32))*/ *borrow(&ctx, 300))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((7*trace_length)/64))*/ *borrow(&ctx, 301))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^(trace_length/8))*/ *borrow(&ctx, 302))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((9*trace_length)/64))*/ *borrow(&ctx, 303))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((5*trace_length)/32))*/ *borrow(&ctx, 304))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((11*trace_length)/64))*/ *borrow(&ctx, 305))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((3*trace_length)/16))*/ *borrow(&ctx, 306))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((13*trace_length)/64))*/ *borrow(&ctx, 307))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((7*trace_length)/32))*/ *borrow(&ctx, 308))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((15*trace_length)/64))*/ *borrow(&ctx, 309))) % PRIME)), /*domain8*/ *borrow(&ctx, 342));
*borrow_mut(&mut ctx, 344) = val;
};
// domains[11] = point^(trace_length / 128) - trace_generator^(31 * trace_length / 32)
{
let val = ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((31*trace_length)/32))*/ *borrow(&ctx, 324))) % PRIME);
...
{
let val = fmul(fmul(fmul(fmul(fmul(fmul(fmul(fmul(fmul(((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((11*trace_length)/16))*/ *borrow(&ctx, 314))) % PRIME), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((23*trace_length)/32))*/ *borrow(&ctx, 315))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((25*trace_length)/32))*/ *borrow(&ctx, 317))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((13*trace_length)/16))*/ *borrow(&ctx, 318))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((27*trace_length)/32))*/ *borrow(&ctx, 319))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((7*trace_length)/8))*/ *borrow(&ctx, 320))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((29*trace_length)/32))*/ *borrow(&ctx, 321))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((15*trace_length)/16))*/ *borrow(&ctx, 322))) % PRIME)), /*domain9*/ *borrow(&ctx, 343)), /*domain11*/ *borrow(&ctx, 345));
...
{
let val = fmul(fmul(((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((61*trace_length)/64))*/ *borrow(&ctx, 323))) % PRIME), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((63*trace_length)/64))*/ *borrow(&ctx, 325))) % PRIME)), /*domain11*/ *borrow(&ctx, 345));
...
{
let val = fmul(fmul(fmul(((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((19*trace_length)/32))*/ *borrow(&ctx, 311))) % PRIME), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((5*trace_length)/8))*/ *borrow(&ctx, 312))) % PRIME)), ((/*(point^(trace_length/128))*/ *borrow(&ctx, 288) + (PRIME - /*(trace_generator^((21*trace_length)/32))*/ *borrow(&ctx, 313))) % PRIME)), /*domain12*/ *borrow(&ctx, 346));
...
{
let val = ((/*(point^(trace_length/1024))*/ *borrow(&ctx, 287) + (PRIME - /*(trace_generator^((255*trace_length)/256))*/ *borrow(&ctx, 326))) % PRIME);
*borrow_mut(&mut ctx, 350) = val;
};
// domains[17] = point^(trace_length / 1024) - trace_generator^(63 * trace_length / 64)
{
let val = ((/*(point^(trace_length/1024))*/ *borrow(&ctx, 287) + (PRIME - /*(trace_generator^((63*trace_length)/64))*/ *borrow(&ctx, 325))) % PRIME);
*borrow_mut(&mut ctx, 351) = val;
};
// domains[18] = point^(trace_length / 2048) - trace_generator^(trace_length / 2)
{
let val = ((/*(point^(trace_length/2048))*/ *borrow(&ctx, 286) + (PRIME - /*(trace_generator^(trace_length/2))*/ *borrow(&ctx, 310))) % PRIME);
...
{
let val = ((/*point*/ point + (PRIME - /*(trace_generator^(trace_length-16))*/ *borrow(&ctx, 327))) % PRIME);
...
{
let val = ((/*point*/ point + (PRIME - /*(trace_generator^(trace_length-2))*/ *borrow(&ctx, 328))) % PRIME);
*borrow_mut(&mut ctx, 356) = val;
};
// domains[23] = point - trace_generator^(trace_length - 4)
{
let val = ((/*point*/ point + (PRIME - /*(trace_generator^(trace_length-4))*/ *borrow(&ctx, 329))) % PRIME);
*borrow_mut(&mut ctx, 357) = val;
};
// domains[24] = point - trace_generator^(trace_length - 1)
{
let val = ((/*point*/ point + (PRIME - /*(trace_generator^(trace_length-1))*/ *borrow(&ctx, 330))) % PRIME);
*borrow_mut(&mut ctx, 358) = val;
};
// domains[25] = point - trace_generator^(trace_length - 2048)
{
let val = ((/*point*/ point + (PRIME - /*(trace_generator^(trace_length-2048))*/ *borrow(&ctx, 331))) % PRIME);
*borrow_mut(&mut ctx, 359) = val;
};
// domains[26] = point - trace_generator^(trace_length - 128)
{
let val = ((/*point*/ point + (PRIME - /*(trace_generator^(trace_length-128))*/ *borrow(&ctx, 332))) % PRIME);
*borrow_mut(&mut ctx, 360) = val;
};
// domains[27] = point - trace_generator^(trace_length - 64)
{
let val = ((/*point*/ point + (PRIME - /*(trace_generator^(trace_length-64))*/ *borrow(&ctx, 333))) % PRIME);
...
{
let val = ((/*column0_row0*/ *borrow(&ctx, 42) + (PRIME - ((/*column0_row1*/ *borrow(&ctx, 43) + /*column0_row1*/ *borrow(&ctx, 43)) % PRIME))) % PRIME);
*borrow_mut(&mut ctx, 234) = val;
};
// cpu/decode/opcode_range_check/bit_2 = column0_row2 - (column0_row3 + column0_row3)
{
let val = ((/*column0_row2*/ *borrow(&ctx, 44) + (PRIME - ((/*column0_row3*/ *borrow(&ctx, 45) + /*column0_row3*/ *borrow(&ctx, 45)) % PRIME))) % PRIME);
*borrow_mut(&mut ctx, 235) = val;
};
// cpu/decode/opcode_range_check/bit_4 = column0_row4 - (column0_row5 + column0_row5)
{
let val = ((/*column0_row4*/ *borrow(&ctx, 46) + (PRIME - ((/*column0_row5*/ *borrow(&ctx, 47) + /*column0_row5*/ *borrow(&ctx, 47)) % PRIME))) % PRIME);
*borrow_mut(&mut ctx, 236) = val;
};
// cpu/decode/opcode_range_check/bit_3 = column0_row3 - (column0_row4 + column0_row4)
{
let val = ((/*column0_row3*/ *borrow(&ctx, 45) + (PRIME - ((/*column0_row4*/ *borrow(&ctx, 46) + /*column0_row4*/ *borrow(&ctx, 46)) % PRIME))) % PRIME);
...
{
let val = ((1 + (PRIME - ((((/*cpu__decode__opcode_range_check__bit_2*/ *borrow(&ctx, 235) + /*cpu__decode__opcode_range_check__bit_4*/ *borrow(&ctx, 236)) % PRIME) + /*cpu__decode__opcode_range_check__bit_3*/ *borrow(&ctx, 237)) % PRIME))) % PRIME);
*borrow_mut(&mut ctx, 238) = val;
};
// cpu/decode/opcode_range_check/bit_5 = column0_row5 - (column0_row6 + column0_row6)
{
let val = ((/*column0_row5*/ *borrow(&ctx, 47) + (PRIME - ((/*column0_row6*/ *borrow(&ctx, 48) + /*column0_row6*/ *borrow(&ctx, 48)) % PRIME))) % PRIME);
*borrow_mut(&mut ctx, 239) = val;
};
// cpu/decode/opcode_range_check/bit_6 = column0_row6 - (column0_row7 + column0_row7)
{
let val = ((/*column0_row6*/ *borrow(&ctx, 48) + (PRIME - ((/*column0_row7*/ *borrow(&ctx, 49) + /*column0_row7*/ *borrow(&ctx, 49)) % PRIME))) % PRIME);
*borrow_mut(&mut ctx, 240) = val;
};
// cpu/decode/opcode_range_check/bit_9 = column0_row9 - (column0_row10 + column0_row10)
{
let val = ((/*column0_row9*/ *borrow(&ctx, 51) + (PRIME - ((/*column0_row10*/ *borrow(&ctx, 52) + /*column0_row10*/ *borrow(&ctx, 52)) % PRIME))) % PRIME);
...
{
let val = ((1 + (PRIME - ((((/*cpu__decode__opcode_range_check__bit_5*/ *borrow(&ctx, 239) + /*cpu__decode__opcode_range_check__bit_6*/ *borrow(&ctx, 240)) % PRIME) + /*cpu__decode__opcode_range_check__bit_9*/ *borrow(&ctx, 241)) % PRIME))) % PRIME);
*borrow_mut(&mut ctx, 242) = val;
};
// cpu/decode/opcode_range_check/bit_7 = column0_row7 - (column0_row8 + column0_row8)
{
let val = ((/*column0_row7*/ *borrow(&ctx, 49) + (PRIME - ((/*column0_row8*/ *borrow(&ctx, 50) + /*column0_row8*/ *borrow(&ctx, 50)) % PRIME))) % PRIME);
*borrow_mut(&mut ctx, 243) = val;
};
// cpu/decode/opcode_range_check/bit_8 = column0_row8 - (column0_row9 + column0_row9)
{
let val = ((/*column0_row8*/ *borrow(&ctx, 50) + (PRIME - ((/*column0_row9*/ *borrow(&ctx, 51) + /*column0_row9*/ *borrow(&ctx, 51)) % PRIME))) % PRIME);
...
{
let val = ((1 + (PRIME - ((((/*cpu__decode__opcode_range_check__bit_7*/ *borrow(&ctx, 243) + /*cpu__decode__opcode_range_check__bit_8*/ *borrow(&ctx, 244)) % PRIME) + /*cpu__decode__opcode_range_check__bit_9*/ *borrow(&ctx, 241)) % PRIME))) % PRIME);
*borrow_mut(&mut ctx, 245) = val;
};
// cpu/decode/opcode_range_check/bit_12 = column0_row12 - (column0_row13 + column0_row13)
{
let val = ((/*column0_row12*/ *borrow(&ctx, 54) + (PRIME - ((/*column0_row13*/ *borrow(&ctx, 55) + /*column0_row13*/ *borrow(&ctx, 55)) % PRIME))) % PRIME);
*borrow_mut(&mut ctx, 246) = val;
};
// cpu/decode/opcode_range_check/bit_13 = column0_row13 - (column0_row14 + column0_row14)
{
let val = ((/*column0_row13*/ *borrow(&ctx, 55) + (PRIME - ((/*column0_row14*/ *borrow(&ctx, 56) + /*column0_row14*/ *borrow(&ctx, 56)) % PRIME))) % PRIME);
...
{
let val = ((1 + (PRIME - ((/*cpu__decode__opcode_range_check__bit_12*/ *borrow(&ctx, 246) + /*cpu__decode__opcode_range_check__bit_13*/ *borrow(&ctx, 247)) % PRIME))) % PRIME);
*borrow_mut(&mut ctx, 248) = val;
};
// cpu/decode/opcode_range_check/bit_1 = column0_row1 - (column0_row2 + column0_row2)
{
let val = ((/*column0_row1*/ *borrow(&ctx, 43) + (PRIME - ((/*column0_row2*/ *borrow(&ctx, 44) + /*column0_row2*/ *borrow(&ctx, 44)) % PRIME))) % PRIME);
*borrow_mut(&mut ctx, 249) = val;
};
// npc_reg_0 = column3_row0 + cpu__decode__opcode_range_check__bit_2 + 1
{
let val = ((((/*column3_row0*/ *borrow(&ctx, 91) + /*cpu__decode__opcode_range_check__bit_2*/ *borrow(&ctx, 235)) % PRIME) + 1) % PRIME);
*borrow_mut(&mut ctx, 250) = val;
};
// cpu/decode/opcode_range_check/bit_10 = column0_row10 - (column0_row11 + column0_row11)
{
let val = ((/*column0_row10*/ *borrow(&ctx, 52) + (PRIME - ((/*column0_row11*/ *borrow(&ctx, 53) + /*column0_row11*/ *borrow(&ctx, 53)) % PRIME))) % PRIME);
*borrow_mut(&mut ctx, 251) = val;
};
// cpu/decode/opcode_range_check/bit_11 = column0_row11 - (column0_row12 + column0_row12)
{
let val = ((/*column0_row11*/ *borrow(&ctx, 53) + (PRIME - ((/*column0_row12*/ *borrow(&ctx, 54) + /*column0_row12*/ *borrow(&ctx, 54)) % PRIME))) % PRIME);
*borrow_mut(&mut ctx, 252) = val;
};
// cpu/decode/opcode_range_check/bit_14 = column0_row14 - (column0_row15 + column0_row15)
{
let val = ((/*column0_row14*/ *borrow(&ctx, 56) + (PRIME - ((/*column0_row15*/ *borrow(&ctx, 57) + /*column0_row15*/ *borrow(&ctx, 57)) % PRIME))) % PRIME);
*borrow_mut(&mut ctx, 253) = val;
};
// memory/address_diff_0 = column4_row2 - column4_row0
{
let val = ((/*column4_row2*/ *borrow(&ctx, 135) + (PRIME - /*column4_row0*/ *borrow(&ctx, 133))) % PRIME);
*borrow_mut(&mut ctx, 254) = val;
};
// range_check16/diff_0 = column6_row6 - column6_row2
{
let val = ((/*column6_row6*/ *borrow(&ctx, 153) + (PRIME - /*column6_row2*/ *borrow(&ctx, 149))) % PRIME);
*borrow_mut(&mut ctx, 255) = val;
};
// pedersen/hash0/ec_subset_sum/bit_0 = column7_row0 - (column7_row4 + column7_row4)
{
let val = ((/*column7_row0*/ *borrow(&ctx, 169) + (PRIME - ((/*column7_row4*/ *borrow(&ctx, 173) + /*column7_row4*/ *borrow(&ctx, 173)) % PRIME))) % PRIME);
...
{
let val = ((fmul(/*range_check_builtin__value0_0*/ *borrow(&ctx, 258), /*offset_size*/ offset_size) + /*column6_row28*/ *borrow(&ctx, 157)) % PRIME);
*borrow_mut(&mut ctx, 259) = val;
};
// range_check_builtin/value2_0 = range_check_builtin__value1_0 * offset_size + column6_row44
{
let val = ((fmul(/*range_check_builtin__value1_0*/ *borrow(&ctx, 259), /*offset_size*/ offset_size) + /*column6_row44*/ *borrow(&ctx, 158)) % PRIME);
*borrow_mut(&mut ctx, 260) = val;
};
// range_check_builtin/value3_0 = range_check_builtin__value2_0 * offset_size + column6_row60
{
let val = ((fmul(/*range_check_builtin__value2_0*/ *borrow(&ctx, 260), /*offset_size*/ offset_size) + /*column6_row60*/ *borrow(&ctx, 159)) % PRIME);
*borrow_mut(&mut ctx, 261) = val;
};
// range_check_builtin/value4_0 = range_check_builtin__value3_0 * offset_size + column6_row76
{
let val = ((fmul(/*range_check_builtin__value3_0*/ *borrow(&ctx, 261), /*offset_size*/ offset_size) + /*column6_row76*/ *borrow(&ctx, 160)) % PRIME);
*borrow_mut(&mut ctx, 262) = val;
};
// range_check_builtin/value5_0 = range_check_builtin__value4_0 * offset_size + column6_row92
{
let val = ((fmul(/*range_check_builtin__value4_0*/ *borrow(&ctx, 262), /*offset_size*/ offset_size) + /*column6_row92*/ *borrow(&ctx, 161)) % PRIME);
*borrow_mut(&mut ctx, 263) = val;
};
// range_check_builtin/value6_0 = range_check_builtin__value5_0 * offset_size + column6_row108
{
let val = ((fmul(/*range_check_builtin__value5_0*/ *borrow(&ctx, 263), /*offset_size*/ offset_size) + /*column6_row108*/ *borrow(&ctx, 162)) % PRIME);
*borrow_mut(&mut ctx, 264) = val;
};
// range_check_builtin/value7_0 = range_check_builtin__value6_0 * offset_size + column6_row124
{
let val = ((fmul(/*range_check_builtin__value6_0*/ *borrow(&ctx, 264), /*offset_size*/ offset_size) + /*column6_row124*/ *borrow(&ctx, 163)) % PRIME);
...
{
let val =((fmul(/*cpu__decode__opcode_range_check__bit_0*/ *borrow(&ctx, 234), /*cpu__decode__opcode_range_check__bit_0*/ *borrow(&ctx, 234)) + (PRIME - /*cpu__decode__opcode_range_check__bit_0*/ *borrow(&ctx, 234))) % PRIME);
// Numerator
// val *= numerator
...
{
let val =((/*column3_row1*/ *borrow(&ctx, 92) + (PRIME - ((fmul(((fmul(((fmul(/*column0_row0*/ *borrow(&ctx, 42), /*offset_size*/ offset_size) + /*column6_row4*/ *borrow(&ctx, 151)) % PRIME), /*offset_size*/ offset_size) + /*column6_row8*/ *borrow(&ctx, 155)) % PRIME), /*offset_size*/ offset_size) + /*column6_row0*/ *borrow(&ctx, 147)) % PRIME))) % PRIME);
...
{
let val =((fmul(/*cpu__decode__flag_op1_base_op0_0*/ *borrow(&ctx, 238), /*cpu__decode__flag_op1_base_op0_0*/ *borrow(&ctx, 238)) + (PRIME - /*cpu__decode__flag_op1_base_op0_0*/ *borrow(&ctx, 238))) % PRIME);
...
{
let val =((fmul(/*cpu__decode__flag_res_op1_0*/ *borrow(&ctx, 242), /*cpu__decode__flag_res_op1_0*/ *borrow(&ctx, 242)) + (PRIME - /*cpu__decode__flag_res_op1_0*/ *borrow(&ctx, 242))) % PRIME);
...
{
let val =((fmul(/*cpu__decode__flag_pc_update_regular_0*/ *borrow(&ctx, 245), /*cpu__decode__flag_pc_update_regular_0*/ *borrow(&ctx, 245)) + (PRIME - /*cpu__decode__flag_pc_update_regular_0*/ *borrow(&ctx, 245))) % PRIME);
...
{
let val =((fmul(/*cpu__decode__fp_update_regular_0*/ *borrow(&ctx, 248), /*cpu__decode__fp_update_regular_0*/ *borrow(&ctx, 248)) + (PRIME - /*cpu__decode__fp_update_regular_0*/ *borrow(&ctx, 248))) % PRIME);
...
{
let val =((((/*column3_row8*/ *borrow(&ctx, 99) + /*half_offset_size*/ half_offset_size) % PRIME) + (PRIME - ((((fmul(/*cpu__decode__opcode_range_check__bit_0*/ *borrow(&ctx, 234), /*column8_row8*/ *borrow(&ctx, 200)) + fmul(((1 + (PRIME - /*cpu__decode__opcode_range_check__bit_0*/ *borrow(&ctx, 234))) % PRIME), /*column8_row0*/ *borrow(&ctx, 194))) % PRIME) + /*column6_row0*/ *borrow(&ctx, 147)) % PRIME))) % PRIME);
...
{
let val =((((/*column3_row4*/ *borrow(&ctx, 95) + /*half_offset_size*/ half_offset_size) % PRIME) + (PRIME - ((((fmul(/*cpu__decode__opcode_range_check__bit_1*/ *borrow(&ctx, 249), /*column8_row8*/ *borrow(&ctx, 200)) + fmul(((1 + (PRIME - /*cpu__decode__opcode_range_check__bit_1*/ *borrow(&ctx, 249))) % PRIME), /*column8_row0*/ *borrow(&ctx, 194))) % PRIME) + /*column6_row8*/ *borrow(&ctx, 155)) % PRIME))) % PRIME);
...
{
let val =((/*column8_row4*/ *borrow(&ctx, 197) + (PRIME - fmul(/*column3_row5*/ *borrow(&ctx, 96), /*column3_row13*/ *borrow(&ctx, 104)))) % PRIME);
...
{
let val =((/*column8_row2*/ *borrow(&ctx, 196) + (PRIME - fmul(/*cpu__decode__opcode_range_check__bit_9*/ *borrow(&ctx, 241), /*column3_row9*/ *borrow(&ctx, 100)))) % PRIME);
// Numerator
// val *= numerator
...
{
let val =((/*column8_row10*/ *borrow(&ctx, 202) + (PRIME - fmul(/*column8_row2*/ *borrow(&ctx, 196), /*column8_row12*/ *borrow(&ctx, 203)))) % PRIME);
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 383));
...
{
let val =((((fmul(((1 + (PRIME - /*cpu__decode__opcode_range_check__bit_9*/ *borrow(&ctx, 241))) % PRIME), /*column3_row16*/ *borrow(&ctx, 105)) + fmul(/*column8_row2*/ *borrow(&ctx, 196), ((/*column3_row16*/ *borrow(&ctx, 105) + (PRIME - ((/*column3_row0*/ *borrow(&ctx, 91) + /*column3_row13*/ *borrow(&ctx, 104)) % PRIME))) % PRIME))) % PRIME) + (PRIME - ((((fmul(/*cpu__decode__flag_pc_update_regular_0*/ *borrow(&ctx, 245), /*npc_reg_0*/ *borrow(&ctx, 250)) + fmul(/*cpu__decode__opcode_range_check__bit_7*/ *borrow(&ctx, 243), /*column8_row12*/ *borrow(&ctx, 203))) % PRIME) + fmul(/*cpu__decode__opcode_range_check__bit_8*/ *borrow(&ctx, 244), ((/*column3_row0*/ *borrow(&ctx, 91) + /*column8_row12*/ *borrow(&ctx, 203)) % PRIME))) % PRIME))) % PRIME);
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 383));
...
{
let val =fmul(((/*column8_row10*/ *borrow(&ctx, 202) + (PRIME - /*cpu__decode__opcode_range_check__bit_9*/ *borrow(&ctx, 241))) % PRIME), ((/*column3_row16*/ *borrow(&ctx, 105) + (PRIME - /*npc_reg_0*/ *borrow(&ctx, 250))) % PRIME));
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 383));
...
{
let val =((/*column8_row16*/ *borrow(&ctx, 206) + (PRIME - ((((((/*column8_row0*/ *borrow(&ctx, 194) + fmul(/*cpu__decode__opcode_range_check__bit_10*/ *borrow(&ctx, 251), /*column8_row12*/ *borrow(&ctx, 203))) % PRIME) + /*cpu__decode__opcode_range_check__bit_11*/ *borrow(&ctx, 252)) % PRIME) + fmul(/*cpu__decode__opcode_range_check__bit_12*/ *borrow(&ctx, 246), 2)) % PRIME))) % PRIME);
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 383));
...
{
let val =fmul(/*cpu__decode__opcode_range_check__bit_12*/ *borrow(&ctx, 246), ((/*column3_row9*/ *borrow(&ctx, 100) + (PRIME - /*column8_row8*/ *borrow(&ctx, 200))) % PRIME));
...
{
let val =fmul(/*cpu__decode__opcode_range_check__bit_12*/ *borrow(&ctx, 246), ((/*column3_row5*/ *borrow(&ctx, 96) + (PRIME - /*npc_reg_0*/ *borrow(&ctx, 250))) % PRIME));
...
{
let val =fmul(/*cpu__decode__opcode_range_check__bit_12*/ *borrow(&ctx, 246), ((/*column6_row0*/ *borrow(&ctx, 147) + (PRIME - /*half_offset_size*/ half_offset_size)) % PRIME));
...
{
let val =fmul(/*cpu__decode__opcode_range_check__bit_12*/ *borrow(&ctx, 246), ((/*column6_row8*/ *borrow(&ctx, 155) + (PRIME - ((/*half_offset_size*/ half_offset_size + 1) % PRIME))) % PRIME));
...
{
let val =fmul(/*cpu__decode__opcode_range_check__bit_12*/ *borrow(&ctx, 246), ((((((((/*cpu__decode__opcode_range_check__bit_12*/ *borrow(&ctx, 246) + /*cpu__decode__opcode_range_check__bit_12*/ *borrow(&ctx, 246)) % PRIME) + 1) % PRIME) + 1) % PRIME) + (PRIME - ((((/*cpu__decode__opcode_range_check__bit_0*/ *borrow(&ctx, 234) + /*cpu__decode__opcode_range_check__bit_1*/ *borrow(&ctx, 249)) % PRIME) + 4) % PRIME))) % PRIME));
...
{
let val =fmul(/*cpu__decode__opcode_range_check__bit_13*/ *borrow(&ctx, 247), ((((/*column6_row0*/ *borrow(&ctx, 147) + 2) % PRIME) + (PRIME - /*half_offset_size*/ half_offset_size)) % PRIME));
...
{
let val =fmul(/*cpu__decode__opcode_range_check__bit_13*/ *borrow(&ctx, 247), ((((/*column6_row4*/ *borrow(&ctx, 151) + 1) % PRIME) + (PRIME - /*half_offset_size*/ half_offset_size)) % PRIME));
...
{
let val =fmul(/*cpu__decode__opcode_range_check__bit_13*/ *borrow(&ctx, 247), ((((((((/*cpu__decode__opcode_range_check__bit_7*/ *borrow(&ctx, 243) + /*cpu__decode__opcode_range_check__bit_0*/ *borrow(&ctx, 234)) % PRIME) + /*cpu__decode__opcode_range_check__bit_3*/ *borrow(&ctx, 237)) % PRIME) + /*cpu__decode__flag_res_op1_0*/ *borrow(&ctx, 242)) % PRIME) + (PRIME - 4)) % PRIME));
...
{
let val =fmul(/*cpu__decode__opcode_range_check__bit_14*/ *borrow(&ctx, 253), ((/*column3_row9*/ *borrow(&ctx, 100) + (PRIME - /*column8_row12*/ *borrow(&ctx, 203))) % PRIME));
...
{
let val =((fmul(((/*memory__multi_column_perm__perm__interaction_elm*/ memory__multi_column_perm__perm__interaction_elm + (PRIME - ((/*column4_row2*/ *borrow(&ctx, 135) + fmul(/*memory__multi_column_perm__hash_interaction_elm0*/ memory__multi_column_perm__hash_interaction_elm0, /*column4_row3*/ *borrow(&ctx, 136))) % PRIME))) % PRIME), /*column11_inter1_row2*/ *borrow(&ctx, 232)) + (PRIME - fmul(((/*memory__multi_column_perm__perm__interaction_elm*/ memory__multi_column_perm__perm__interaction_elm + (PRIME - ((/*column3_row2*/ *borrow(&ctx, 93) + fmul(/*memory__multi_column_perm__hash_interaction_elm0*/ memory__multi_column_perm__hash_interaction_elm0, /*column3_row3*/ *borrow(&ctx, 94))) % PRIME))) % PRIME), /*column11_inter1_row0*/ *borrow(&ctx, 230)))) % PRIME);
// Numerator
// val *= numerator
...
{
let val =((/*column11_inter1_row0*/ *borrow(&ctx, 230) + (PRIME - /*memory__multi_column_perm__perm__public_memory_prod*/ memory__multi_column_perm__perm__public_memory_prod)) % PRIME);
...
{
let val =((fmul(/*memory__address_diff_0*/ *borrow(&ctx, 254), /*memory__address_diff_0*/ *borrow(&ctx, 254)) + (PRIME - /*memory__address_diff_0*/ *borrow(&ctx, 254))) % PRIME);
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 386));
...
{
let val =fmul(((/*memory__address_diff_0*/ *borrow(&ctx, 254) + (PRIME - 1)) % PRIME), ((/*column4_row1*/ *borrow(&ctx, 134) + (PRIME - /*column4_row3*/ *borrow(&ctx, 136))) % PRIME));
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 386));
...
{
let val =((((fmul(((/*range_check16__perm__interaction_elm*/ range_check16__perm__interaction_elm + (PRIME - /*column6_row2*/ *borrow(&ctx, 149))) % PRIME), /*column11_inter1_row1*/ *borrow(&ctx, 231)) + /*column6_row0*/ *borrow(&ctx, 147)) % PRIME) + (PRIME - /*range_check16__perm__interaction_elm*/ range_check16__perm__interaction_elm)) % PRIME);
...
{
let val =((fmul(((/*range_check16__perm__interaction_elm*/ range_check16__perm__interaction_elm + (PRIME - /*column6_row6*/ *borrow(&ctx, 153))) % PRIME), /*column11_inter1_row5*/ *borrow(&ctx, 233)) + (PRIME - fmul(((/*range_check16__perm__interaction_elm*/ range_check16__perm__interaction_elm + (PRIME - /*column6_row4*/ *borrow(&ctx, 151))) % PRIME), /*column11_inter1_row1*/ *borrow(&ctx, 231)))) % PRIME);
// Numerator
// val *= numerator
...
{
let val =((/*column11_inter1_row1*/ *borrow(&ctx, 231) + (PRIME - /*range_check16__perm__public_memory_prod*/ range_check16__perm__public_memory_prod)) % PRIME);
...
{
let val =((fmul(/*range_check16__diff_0*/ *borrow(&ctx, 255), /*range_check16__diff_0*/ *borrow(&ctx, 255)) + (PRIME - /*range_check16__diff_0*/ *borrow(&ctx, 255))) % PRIME);
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 388));
...
{
let val =((/*column6_row2*/ *borrow(&ctx, 149) + (PRIME - /*range_check_min*/ range_check_min)) % PRIME);
...
{
let val =((/*column6_row2*/ *borrow(&ctx, 149) + (PRIME - /*range_check_max*/ range_check_max)) % PRIME);
...
{
let val =((((fmul(((/*diluted_check__permutation__interaction_elm*/ diluted_check__permutation__interaction_elm + (PRIME - /*column2_row0*/ *borrow(&ctx, 89))) % PRIME), /*column10_inter1_row0*/ *borrow(&ctx, 228)) + /*column1_row0*/ *borrow(&ctx, 58)) % PRIME) + (PRIME - /*diluted_check__permutation__interaction_elm*/ diluted_check__permutation__interaction_elm)) % PRIME);
...
{
let val =((fmul(((/*diluted_check__permutation__interaction_elm*/ diluted_check__permutation__interaction_elm + (PRIME - /*column2_row1*/ *borrow(&ctx, 90))) % PRIME), /*column10_inter1_row1*/ *borrow(&ctx, 229)) + (PRIME - fmul(((/*diluted_check__permutation__interaction_elm*/ diluted_check__permutation__interaction_elm + (PRIME - /*column1_row1*/ *borrow(&ctx, 59))) % PRIME), /*column10_inter1_row0*/ *borrow(&ctx, 228)))) % PRIME);
// Numerator
// val *= numerator
...
{
let val =((/*column10_inter1_row0*/ *borrow(&ctx, 228) + (PRIME - /*diluted_check__permutation__public_memory_prod*/ diluted_check__permutation__public_memory_prod)) % PRIME);
...
{
let val =((/*column2_row0*/ *borrow(&ctx, 89) + (PRIME - /*diluted_check__first_elm*/ diluted_check__first_elm)) % PRIME);
...
{
let val =((/*column9_inter1_row1*/ *borrow(&ctx, 227) + (PRIME - ((fmul(/*column9_inter1_row0*/ *borrow(&ctx, 226), ((1 + fmul(/*diluted_check__interaction_z*/ diluted_check__interaction_z, ((/*column2_row1*/ *borrow(&ctx, 90) + (PRIME - /*column2_row0*/ *borrow(&ctx, 89))) % PRIME))) % PRIME)) + fmul(fmul(/*diluted_check__interaction_alpha*/ diluted_check__interaction_alpha, ((/*column2_row1*/ *borrow(&ctx, 90) + (PRIME - /*column2_row0*/ *borrow(&ctx, 89))) % PRIME)), ((/*column2_row1*/ *borrow(&ctx, 90) + (PRIME - /*column2_row0*/ *borrow(&ctx, 89))) % PRIME))) % PRIME))) % PRIME);
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 389));
...
{
let val =((/*column9_inter1_row0*/ *borrow(&ctx, 226) + (PRIME - /*diluted_check__final_cum_val*/ diluted_check__final_cum_val)) % PRIME);
...
{
let val =fmul(/*column7_row89*/ *borrow(&ctx, 185), /*pedersen__hash0__ec_subset_sum__bit_0*/ *borrow(&ctx, 256));
...
{
let val =fmul(/*column7_row89*/ *borrow(&ctx, 185), ((/*column7_row4*/ *borrow(&ctx, 173) + (PRIME - fmul(3138550867693340381917894711603833208051177722232017256448, /*column7_row768*/ *borrow(&ctx, 186)))) % PRIME));
...
{
let val =((/*column7_row89*/ *borrow(&ctx, 185) + (PRIME - fmul(/*column7_row1022*/ *borrow(&ctx, 192), ((/*column7_row768*/ *borrow(&ctx, 186) + (PRIME - ((/*column7_row772*/ *borrow(&ctx, 187) + /*column7_row772*/ *borrow(&ctx, 187)) % PRIME))) % PRIME)))) % PRIME);
...
{
let val =fmul(/*column7_row1022*/ *borrow(&ctx, 192), ((/*column7_row772*/ *borrow(&ctx, 187) + (PRIME - fmul(8, /*column7_row784*/ *borrow(&ctx, 188)))) % PRIME));
...
{
let val =((/*column7_row1022*/ *borrow(&ctx, 192) + (PRIME - fmul(((/*column7_row1004*/ *borrow(&ctx, 190) + (PRIME - ((/*column7_row1008*/ *borrow(&ctx, 191) + /*column7_row1008*/ *borrow(&ctx, 191)) % PRIME))) % PRIME), ((/*column7_row784*/ *borrow(&ctx, 188) + (PRIME - ((/*column7_row788*/ *borrow(&ctx, 189) + /*column7_row788*/ *borrow(&ctx, 189)) % PRIME))) % PRIME)))) % PRIME);
...
{
let val =fmul(((/*column7_row1004*/ *borrow(&ctx, 190) + (PRIME - ((/*column7_row1008*/ *borrow(&ctx, 191) + /*column7_row1008*/ *borrow(&ctx, 191)) % PRIME))) % PRIME), ((/*column7_row788*/ *borrow(&ctx, 189) + (PRIME - fmul(18014398509481984, /*column7_row1004*/ *borrow(&ctx, 190)))) % PRIME));
...
{
let val =fmul(/*pedersen__hash0__ec_subset_sum__bit_0*/ *borrow(&ctx, 256), ((/*pedersen__hash0__ec_subset_sum__bit_0*/ *borrow(&ctx, 256) + (PRIME - 1)) % PRIME));
// Numerator
// val *= numerator
...
{
let val =((fmul(/*pedersen__hash0__ec_subset_sum__bit_0*/ *borrow(&ctx, 256), ((/*column6_row3*/ *borrow(&ctx, 150) + (PRIME - /*pedersen__points__y*/ pedersen__points__y)) % PRIME)) + (PRIME - fmul(/*column7_row2*/ *borrow(&ctx, 171), ((/*column6_row1*/ *borrow(&ctx, 148) + (PRIME - /*pedersen__points__x*/ pedersen__points__x)) % PRIME)))) % PRIME);
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 391));
...
{
let val =((fmul(/*column7_row2*/ *borrow(&ctx, 171), /*column7_row2*/ *borrow(&ctx, 171)) + (PRIME - fmul(/*pedersen__hash0__ec_subset_sum__bit_0*/ *borrow(&ctx, 256), ((((/*column6_row1*/ *borrow(&ctx, 148) + /*pedersen__points__x*/ pedersen__points__x) % PRIME) + /*column6_row5*/ *borrow(&ctx, 152)) % PRIME)))) % PRIME);
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 391));
...
{
let val =((fmul(/*pedersen__hash0__ec_subset_sum__bit_0*/ *borrow(&ctx, 256), ((/*column6_row3*/ *borrow(&ctx, 150) + /*column6_row7*/ *borrow(&ctx, 154)) % PRIME)) + (PRIME - fmul(/*column7_row2*/ *borrow(&ctx, 171), ((/*column6_row1*/ *borrow(&ctx, 148) + (PRIME - /*column6_row5*/ *borrow(&ctx, 152))) % PRIME)))) % PRIME);
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 391));
...
{
let val =fmul(/*pedersen__hash0__ec_subset_sum__bit_neg_0*/ *borrow(&ctx, 257), ((/*column6_row5*/ *borrow(&ctx, 152) + (PRIME - /*column6_row1*/ *borrow(&ctx, 148))) % PRIME));
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 391));
...
{
let val =fmul(/*pedersen__hash0__ec_subset_sum__bit_neg_0*/ *borrow(&ctx, 257), ((/*column6_row7*/ *borrow(&ctx, 154) + (PRIME - /*column6_row3*/ *borrow(&ctx, 150))) % PRIME));
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 391));
...
{
let val =((/*column6_row1025*/ *borrow(&ctx, 166) + (PRIME - /*column6_row1021*/ *borrow(&ctx, 164))) % PRIME);
// Numerator
// val *= numerator
...
{
let val =((/*column6_row1027*/ *borrow(&ctx, 167) + (PRIME - /*column6_row1023*/ *borrow(&ctx, 165))) % PRIME);
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 352));
...
{
let val =((/*column6_row1*/ *borrow(&ctx, 148) + (PRIME - /*pedersen__shift_point__x*/ pedersen__shift_point__x)) % PRIME);
...
{
let val =((/*column6_row3*/ *borrow(&ctx, 150) + (PRIME - /*pedersen__shift_point__y*/ pedersen__shift_point__y)) % PRIME);
...
{
let val =((/*column3_row11*/ *borrow(&ctx, 102) + (PRIME - /*column7_row0*/ *borrow(&ctx, 169))) % PRIME);
...
{
let val =((/*column3_row2058*/ *borrow(&ctx, 132) + (PRIME - ((/*column3_row522*/ *borrow(&ctx, 128) + 1) % PRIME))) % PRIME);
// Numerator
// val *= numerator
...
{
let val =((/*column3_row10*/ *borrow(&ctx, 101) + (PRIME - /*initial_pedersen_addr*/ initial_pedersen_addr)) % PRIME);
...
{
let val =((/*column3_row1035*/ *borrow(&ctx, 131) + (PRIME - /*column7_row1024*/ *borrow(&ctx, 193))) % PRIME);
...
{
let val =((/*column3_row1034*/ *borrow(&ctx, 130) + (PRIME - ((/*column3_row10*/ *borrow(&ctx, 101) + 1) % PRIME))) % PRIME);
...
{
let val =((/*column3_row523*/ *borrow(&ctx, 129) + (PRIME - /*column6_row2045*/ *borrow(&ctx, 168))) % PRIME);
...
{
let val =((/*column3_row522*/ *borrow(&ctx, 128) + (PRIME - ((/*column3_row1034*/ *borrow(&ctx, 130) + 1) % PRIME))) % PRIME);
...
{
let val =((/*range_check_builtin__value7_0*/ *borrow(&ctx, 265) + (PRIME - /*column3_row75*/ *borrow(&ctx, 118))) % PRIME);
...
{
let val =((/*column3_row202*/ *borrow(&ctx, 127) + (PRIME - ((/*column3_row74*/ *borrow(&ctx, 117) + 1) % PRIME))) % PRIME);
// Numerator
// val *= numerator
...
{
let val =((/*column3_row74*/ *borrow(&ctx, 117) + (PRIME - /*initial_range_check_addr*/ initial_range_check_addr)) % PRIME);
...
{
let val =((/*column3_row26*/ *borrow(&ctx, 108) + (PRIME - /*initial_bitwise_addr*/ initial_bitwise_addr)) % PRIME);
...
{
let val =((/*column3_row58*/ *borrow(&ctx, 114) + (PRIME - ((/*column3_row26*/ *borrow(&ctx, 108) + 1) % PRIME))) % PRIME);
// Numerator
// val *= numerator
...
{
let val =((/*column3_row42*/ *borrow(&ctx, 112) + (PRIME - ((/*column3_row122*/ *borrow(&ctx, 124) + 1) % PRIME))) % PRIME);
...
{
let val =((/*column3_row154*/ *borrow(&ctx, 126) + (PRIME - ((/*column3_row42*/ *borrow(&ctx, 112) + 1) % PRIME))) % PRIME);
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 360));
...
{
let val =((((/*bitwise__sum_var_0_0*/ *borrow(&ctx, 266) + /*bitwise__sum_var_8_0*/ *borrow(&ctx, 267)) % PRIME) + (PRIME - /*column3_row27*/ *borrow(&ctx, 109))) % PRIME);
...
{
let val =((/*column3_row43*/ *borrow(&ctx, 113) + (PRIME - ((/*column3_row91*/ *borrow(&ctx, 121) + /*column3_row123*/ *borrow(&ctx, 125)) % PRIME))) % PRIME);
...
{
let val =((((/*column1_row0*/ *borrow(&ctx, 58) + /*column1_row32*/ *borrow(&ctx, 75)) % PRIME) + (PRIME - ((((/*column1_row96*/ *borrow(&ctx, 83) + /*column1_row64*/ *borrow(&ctx, 77)) % PRIME) + /*column1_row64*/ *borrow(&ctx, 77)) % PRIME))) % PRIME);
...
{
let val =((fmul(((/*column1_row88*/ *borrow(&ctx, 79) + /*column1_row120*/ *borrow(&ctx, 85)) % PRIME), 16) + (PRIME - /*column1_row1*/ *borrow(&ctx, 59))) % PRIME);
...
{
let val =((fmul(((/*column1_row90*/ *borrow(&ctx, 80) + /*column1_row122*/ *borrow(&ctx, 86)) % PRIME), 16) + (PRIME - /*column1_row65*/ *borrow(&ctx, 78))) % PRIME);
...
{
let val =((fmul(((/*column1_row92*/ *borrow(&ctx, 81) + /*column1_row124*/ *borrow(&ctx, 87)) % PRIME), 16) + (PRIME - /*column1_row33*/ *borrow(&ctx, 76))) % PRIME);
...
{
let val =((fmul(((/*column1_row94*/ *borrow(&ctx, 82) + /*column1_row126*/ *borrow(&ctx, 88)) % PRIME), 256) + (PRIME - /*column1_row97*/ *borrow(&ctx, 84))) % PRIME);
...
{
let val =((/*column3_row6*/ *borrow(&ctx, 97) + (PRIME - /*initial_poseidon_addr*/ initial_poseidon_addr)) % PRIME);
...
{
let val =((/*column3_row70*/ *borrow(&ctx, 115) + (PRIME - ((/*column3_row6*/ *borrow(&ctx, 97) + 3) % PRIME))) % PRIME);
// Numerator
// val *= numerator
...
{
let val =((/*column3_row38*/ *borrow(&ctx, 110) + (PRIME - ((/*initial_poseidon_addr*/ initial_poseidon_addr + 1) % PRIME))) % PRIME);
...
{
let val =((/*column3_row102*/ *borrow(&ctx, 122) + (PRIME - ((/*column3_row38*/ *borrow(&ctx, 110) + 3) % PRIME))) % PRIME);
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 361));
...
{
let val =((/*column3_row22*/ *borrow(&ctx, 106) + (PRIME - ((/*initial_poseidon_addr*/ initial_poseidon_addr + 2) % PRIME))) % PRIME);
...
{
let val =((/*column3_row86*/ *borrow(&ctx, 119) + (PRIME - ((/*column3_row22*/ *borrow(&ctx, 106) + 3) % PRIME))) % PRIME);
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 361));
...
{
let val =((fmul(/*column8_row6*/ *borrow(&ctx, 199), /*column8_row6*/ *borrow(&ctx, 199)) + (PRIME - /*column8_row9*/ *borrow(&ctx, 201))) % PRIME);
...
{
let val =((fmul(/*column8_row14*/ *borrow(&ctx, 205), /*column8_row14*/ *borrow(&ctx, 205)) + (PRIME - /*column8_row5*/ *borrow(&ctx, 198))) % PRIME);
...
{
let val =((fmul(/*column8_row1*/ *borrow(&ctx, 195), /*column8_row1*/ *borrow(&ctx, 195)) + (PRIME - /*column8_row13*/ *borrow(&ctx, 204))) % PRIME);
...
{
let val =((fmul(/*column5_row0*/ *borrow(&ctx, 137), /*column5_row0*/ *borrow(&ctx, 137)) + (PRIME - /*column5_row1*/ *borrow(&ctx, 138))) % PRIME);
...
{
let val =((fmul(/*column7_row1*/ *borrow(&ctx, 170), /*column7_row1*/ *borrow(&ctx, 170)) + (PRIME - /*column7_row3*/ *borrow(&ctx, 172))) % PRIME);
// Numerator
// val *= numerator
...
{
let val =((((/*column3_row7*/ *borrow(&ctx, 98) + 2950795762459345168613727575620414179244544320470208355568817838579231751791) % PRIME) + (PRIME - /*column8_row6*/ *borrow(&ctx, 199))) % PRIME);
...
{
let val =((((/*column3_row39*/ *borrow(&ctx, 111) + 1587446564224215276866294500450702039420286416111469274423465069420553242820) % PRIME) + (PRIME - /*column8_row14*/ *borrow(&ctx, 205))) % PRIME);
...
{
let val =((((/*column3_row23*/ *borrow(&ctx, 107) + 1645965921169490687904413452218868659025437693527479459426157555728339600137) % PRIME) + (PRIME - /*column8_row1*/ *borrow(&ctx, 195))) % PRIME);
...
{
let val =((/*column8_row22*/ *borrow(&ctx, 208) + (PRIME - ((((((((((/*poseidon__poseidon__full_rounds_state0_cubed_0*/ *borrow(&ctx, 268) + /*poseidon__poseidon__full_rounds_state0_cubed_0*/ *borrow(&ctx, 268)) % PRIME) + /*poseidon__poseidon__full_rounds_state0_cubed_0*/ *borrow(&ctx, 268)) % PRIME) + /*poseidon__poseidon__full_rounds_state1_cubed_0*/ *borrow(&ctx, 269)) % PRIME) + /*poseidon__poseidon__full_rounds_state2_cubed_0*/ *borrow(&ctx, 270)) % PRIME) + /*poseidon__poseidon__full_round_key0*/ poseidon__poseidon__full_round_key0) % PRIME))) % PRIME);
// Numerator
// val *= numerator
...
{
let val =((((/*column8_row30*/ *borrow(&ctx, 210) + /*poseidon__poseidon__full_rounds_state1_cubed_0*/ *borrow(&ctx, 269)) % PRIME) + (PRIME - ((((/*poseidon__poseidon__full_rounds_state0_cubed_0*/ *borrow(&ctx, 268) + /*poseidon__poseidon__full_rounds_state2_cubed_0*/ *borrow(&ctx, 270)) % PRIME) + /*poseidon__poseidon__full_round_key1*/ poseidon__poseidon__full_round_key1) % PRIME))) % PRIME);
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 341));
...
{
let val =((((((/*column8_row17*/ *borrow(&ctx, 207) + /*poseidon__poseidon__full_rounds_state2_cubed_0*/ *borrow(&ctx, 270)) % PRIME) + /*poseidon__poseidon__full_rounds_state2_cubed_0*/ *borrow(&ctx, 270)) % PRIME) + (PRIME - ((((/*poseidon__poseidon__full_rounds_state0_cubed_0*/ *borrow(&ctx, 268) + /*poseidon__poseidon__full_rounds_state1_cubed_0*/ *borrow(&ctx, 269)) % PRIME) + /*poseidon__poseidon__full_round_key2*/ poseidon__poseidon__full_round_key2) % PRIME))) % PRIME);
// Numerator
// val *= numerator
val = fmul(val, *borrow(&ctx, 341));
...
{
let val =((((/*column3_row103*/ *borrow(&ctx, 123) + /*poseidon__poseidon__full_rounds_state1_cubed_7*/ *borrow(&ctx, 272)) % PRIME) + (PRIME - ((/*poseidon__poseidon__full_rounds_state0_cubed_7*/ *borrow(&ctx, 271) + /*poseidon__poseidon__full_rounds_state2_cubed_7*/ *borrow(&ctx, 273)) % PRIME))) % PRIME);
...
{
let val =((/*column5_row122*/ *borrow(&ctx, 144) + (PRIME - /*column7_row1*/ *borrow(&ctx, 170))) % PRIME);
...
{
let val =((/*column5_row124*/ *borrow(&ctx, 145) + (PRIME - /*column7_row5*/ *borrow(&ctx, 174))) % PRIME);
...
{
let val =((/*column5_row126*/ *borrow(&ctx, 146) + (PRIME - /*column7_row9*/ *borrow(&ctx, 176))) % PRIME);
...
{
let val =((/*column5_row6*/ *borrow(&ctx, 143) + (PRIME - ((((((((((((fmul(8, /*poseidon__poseidon__partial_rounds_state0_cubed_0*/ *borrow(&ctx, 277)) + fmul(4, /*column5_row2*/ *borrow(&ctx, 139))) % PRIME) + fmul(6, /*poseidon__poseidon__partial_rounds_state0_cubed_1*/ *borrow(&ctx, 278))) % PRIME) + /*column5_row4*/ *borrow(&ctx, 141)) % PRIME) + /*column5_row4*/ *borrow(&ctx, 141)) % PRIME) + fmul(3618502788666131213697322783095070105623107215331596699973092056135872020479, /*poseidon__poseidon__partial_rounds_state0_cubed_2*/ *borrow(&ctx, 279))) % PRIME) + /*poseidon__poseidon__partial_round_key0*/ poseidon__poseidon__partial_round_key0) % PRIME))) % PRIME);
// Numerator
// val *= numerator
...
{
let val =((/*column8_row78*/ *borrow(&ctx, 219) + (PRIME - ((((((((fmul(4, /*poseidon__poseidon__partial_rounds_state1_cubed_20*/ *borrow(&ctx, 284)) + /*column7_row85*/ *borrow(&ctx, 183)) % PRIME) + /*column7_row85*/ *borrow(&ctx, 183)) % PRIME) + /*poseidon__poseidon__partial_rounds_state1_cubed_21*/ *borrow(&ctx, 285)) % PRIME) + 1401754474293352309994371631695783042590401941592571735921592823982231996415) % PRIME))) % PRIME);
